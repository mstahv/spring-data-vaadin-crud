...
In this branch we are using the default vaadin-maven-plugin to compile and host the widgetset. The compilation will take bit longer, but should also work in development environments that have strict firewalls.
